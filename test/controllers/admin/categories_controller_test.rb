...
class Admin::CategoriesControllerTest < ActionController::TestCase
  ...
  test "should create admin_category" do
    assert_difference('Admin::Category.count') do
      post :create, admin_category: { category: @admin_category.category, description: @admin_category.description, title: @admin_category.title }
    end
  ...
  test "should update admin_category" do
    patch :update, id: @admin_category, admin_category: { category: @admin_category.category, description: @admin_category.description, title: @admin_category.title }
    assert_redirected_to admin_category_path(assigns(:admin_category))
  end
